...
public class CategoryTest {
    ...
    void cannotAcceptACategoryThatHasEmptyName() {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> {
            new Category("", code, order, description, active, iconPath, colorCode, studyGuide);
        });
    ...
    void cannotAcceptACategoryThatHasNullName() {
        Exception ex = assertThrows(NullPointerException.class, () -> {
            new Category(null, code, order, description, active, iconPath, colorCode, studyGuide);
        });
        assertEquals("The name can't be empty or null", ex.getMessage());
    }
    ...
    void doesNotAcceptNonPatternCode() {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> {
            new Category(name, "asoda-asd*", order, description, active, iconPath, colorCode, studyGuide);
        });
    ...
    void doesNotAcceptAEmptyCode() {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> {
            new Category(name, "", order, description, active, iconPath, colorCode, studyGuide);
        });
        assertEquals("The code must obey the pattern: only lowercase letters and numbers", ex.getMessage());
    }
    ...
    void doesNotAcceptANullCode() {
        Exception ex = assertThrows(NullPointerException.class, () -> {
            new Category(name, null, order, description, active, iconPath, colorCode, studyGuide);
        });
        assertEquals("The code must obey the pattern: only lowercase letters and numbers", ex.getMessage());
    }
    ...
    void notAcceptAEmptyDescription() {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> {
            new Category(name, code, order, "", active, iconPath, colorCode, studyGuide);
        });
    ...
    void notAcceptAEmptyIconPath() {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> {
            new Category(name, code, order, description, active, "", colorCode, studyGuide);
        });
    ...
    void notAcceptANullIconPath() {
        Exception ex = assertThrows(NullPointerException.class, () -> {
            new Category(name, code, order, description, active, null, colorCode, studyGuide);
        });
        assertEquals("The icon path can't be empty or null", ex.getMessage());
    }
    ...
    void notAcceptAInvalidHexadecimalColorCode() {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> {
            new Category(name, code, order, description, active, iconPath, "#FF", studyGuide);
        });
    ...
    void notAcceptAEmptyHexadecimalColorCode() {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> {
            new Category(name, code, order, description, active, iconPath, "", studyGuide);
        });
        assertEquals("The color code should be hexadecimal", ex.getMessage());
    }
    ...
    void notAcceptANullHexadecimalColorCode() {
        Exception ex = assertThrows(NullPointerException.class, () -> {
            new Category(name, code, order, description, active, iconPath, null, studyGuide);
        });
        assertEquals("The color code should be hexadecimal", ex.getMessage());
    }
    ...
    void shouldBeAcceptAValidCategory() {
        assertDoesNotThrow(() -> new Category(name, code, order, description, active, iconPath, colorCode, studyGuide),
                "Throw exception");
    }
}