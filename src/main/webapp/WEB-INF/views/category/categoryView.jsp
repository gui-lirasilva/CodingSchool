...
<head>
    ...
    <title>${categoryProjection.name} | Cursos online de tecnologia</title>
...
<section class="category-banner__wrapper">
    <div class="container category-banner">
            <span class="category-banner__icon">
                <img src="${categoryProjection.iconPath}">
            </span>
        <h1 class="category-banner__title">${categoryProjection.name}</h1>
    </div>
</section>
<main class="container">
    <div class="subcategories">
        ...
        <ul class="subcategories__list">
            <c:forEach items="${categoryProjection.subcategories}" var="subcategory">
